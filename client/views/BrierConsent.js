    ...
    'click #nextBtn': function(event, template) {
        ...
        if (assignment_Id == "ASSIGNMENT_ID_NOT_AVAILABLE") {
            ...
            if (existedWorker.count() > 0) {
                ...
                Router.go('/BrierTutorial');
            }
        }
    }
};

Template.BrierConsent.rendered = function() {
    $('html,body').scrollTop(0);
};

Template.BrierConsent.created = function() {
    timeSeries.push(Date.now().toString()+' BrierConsent');
